...
<tr class="productoTr">
    <td>
        <div class="producto col-12 p-1 d-flex align-items-center justify-content-center">
    ...
    <td>
        <div class="col-12">
            <p class="p-0 m-0 px-1 text-center">{{ $producto->motivo_devolucion }}</p>
        </div>
    </td>
    <td>
        <div class="col-12">
            <p class="p-0 m-0 px-1 text-center">{{ $producto->tipo_devolucion }}</p>
        </div>
    </td>
    <td>
        <div class="col-12">
